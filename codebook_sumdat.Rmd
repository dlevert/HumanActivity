---
dataMaid: yes
title: Codebook for Summarized Table of Mean Values (sumdat)
date: 2020-08-30 09:46:09
...
-9L)), vnam = "Time GravityAcc-mean-X")
```
...
-8L)), vnam = "Time GravityAcc-mean-Y")
```
...
-8L)), vnam = "Time GravityAcc-mean-Z")
```
...
0L, 1L)), class = "data.frame", row.names = c(NA, -10L)), vnam = "Time BodyAccJerk-mean-X")
```
...
-11L)), vnam = "Time BodyAccJerk-mean-Z")
```
...
-7L)), vnam = "Time BodyGyroJerk-mean-X")
```
...
-7L)), vnam = "Time BodyGyroJerk-mean-Y")
```
...
-8L)), vnam = "FFT BodyAccJerk-mean-X")
```
...
-12L)), vnam = "FFT BodyAccJerk-mean-Z")
```
...
-8L)), vnam = "FFT BodyBodyAccJerkMag-mean")
```
...
-13L)), vnam = "FFT BodyBodyGyroMag-mean")
```
...
-12L)), vnam = "FFT BodyBodyGyroJerkMag-mean")
```
...
1L)), class = "data.frame", row.names = c(NA, -9L)), vnam = "Time GravityAcc-std-X")
```
...
-8L)), vnam = "Time BodyAccJerk-std-X")
```
...
-11L)), vnam = "Time BodyAccJerk-std-Z")
```
...
-12L)), vnam = "Time BodyGyroJerk-std-X")
```
...
-12L)), vnam = "Time BodyGyroJerk-std-Z")
```
...
-13L)), vnam = "FFT BodyBodyGyroMag-std")
```
...
)), vnam = "FFT BodyBodyGyroJerkMag-std")
```
 ...
 *  Report creation time: Sun Aug 30 2020 09:46:10
 ...
 *  Function call: `dataMaid::makeDataReport(data = sumdat, mode = c("summarize", 
"visualize", "check"), smartNum = FALSE, file = "codebook_sumdat.Rmd", 
    ...
    listChecks = FALSE, maxProbVals = Inf, codebook = TRUE, reportTitle = "Codebook for sumdat")`
